# (c) @SDMOVIESFLIXNEW || @PredatorHackerzZ
    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Backup Channel", url="https://t.me/TGRobot_List")
                    ],
                    [
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Movie Group](https://t.me/+zxxliPS_01ZkZTc9)",
                                     disable_web_page_preview=True)
            return
    ...
    if "aboutbot" in cb_data:
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Backup Channel", url="https://t.me/SDMOVIESFLIXofficial")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs"),
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Movie Group](https://t.me/+zxxliPS_01ZkZTc9).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Movie Group](https://t.me/+zxxliPS_01ZkZTc9).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Movie Group", url="https://t.me/+zxxliPS_01ZkZTc9"),
                        InlineKeyboardButton("Movie Channel", url="https://t.me/SDMOVIESFLIXNEW")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("About Dev", callback_data="aboutdevs")
